...
public class StubHubApiTokenGeneratorImplTest {
    ...
    private StubHubApiTokenGeneratorImpl tokenGenerator;

    @Test
    public void testGenerateToken() {
        tokenGenerator = new StubHubApiTokenGeneratorImpl(base64);
