...
public class StubHubEventDeserializer implements JsonDeserializer<StubHubEvent[]> {
    ...
    private StubHubAncestors jsonToAncestors(JsonObject jsonAncestors) {
        ...
        List<StubHubCategory> categories = new ArrayList<>(jsonCategories.size());
        List<StubHubGrouping> groupings = new ArrayList<>(jsonGroupings.size());
        List<StubHubPerformer> performers = new ArrayList<>(jsonPerformers.size());
